...
| 4. Advanced RAG (6 trybów) | 22 | 1.7 |
| 5. Frontend Next.js | 32 | 2.5 |
| 6. Eval + pisanie pracy | 40 | 3.1 |
| Bufor 15% | 30 | 2.3 |
| **Razem** | **~225h** | **~17 tygodni (~4.5 miesiące)** |
...
| 2. Ingestion | 17 | 1.3 |
| 3. Query | 14 | 1.1 |
| 4. Advanced RAG (6 trybów) | 10 | 0.8 |
| 5. Frontend Next.js | 13 | 1.0 |
| 6. Eval + pisanie pracy | 22 | 1.7 |
| Bufor 15% | 14 | 1.1 |
| **Razem** | **~108h** | **~8-9 tygodni (~2 miesiące)** |
...
| 5 | 2-8 czerwca | Generation + Orchestrator vanilla + HyDE: pełny RAG e2e |
| 6 | 9-15 czerwca | Advanced RAG: Self-Reflection + Query Rewriting |
| 7 | 16-22 czerwca | Advanced RAG: Multi-Agent + Corrective RAG; Frontend Next.js |
| 8 | 23-29 czerwca | Admin + Eval Service; eksperyment porównawczy 6 trybów |
