...
\begin{figure}[htbp]
  \centering
  % TODO: insert TikZ component diagram
  \fbox{\parbox{0.8\textwidth}{\centering\vspace{2cm}
    [Figure: RARE-RAG Component Architecture — TikZ]\vspace{2cm}}}
  \caption{\rarerag{} architecture: the four-component pipeline for risk-aware,
